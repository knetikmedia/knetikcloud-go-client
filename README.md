...
*GamificationAchievementsApi* | [**GetAvailableTriggersUsingGET**](docs/GamificationAchievementsApi.md#getavailabletriggersusingget) | **Get** /achievements/triggers | Get the list of triggers that can be used to trigger achievement progress update.
...
*MediaVideosApi* | [**DeleteRelationshipUsingDELETE**](docs/MediaVideosApi.md#deleterelationshipusingdelete) | **Delete** /media/videos/{video_id}/related/{id} | Delete a video&#39;s relationship
...
*MediaVideosApi* | [**UpdateRelationshipUsingPUT**](docs/MediaVideosApi.md#updaterelationshipusingput) | **Put** /media/videos/{video_id}/related/{id}/relationship_details | Update a video&#39;s relationship details
...
*StoreSubscriptionsApi* | [**ListBillingReportsUsingGET**](docs/StoreSubscriptionsApi.md#listbillingreportsusingget) | **Get** /subscriptions/reports | Get a list of available subscription reports in most recent first order

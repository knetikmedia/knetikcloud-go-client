 ...
 */
func (a ActivitiesApi) GetActivities(filterTemplate bool, size int32, page int32, order string) (*PageResourceBareActivityResource, *APIResponse, error) {
 ...
 * @return void
 */
func (a ActivitiesApi) UpdateActivity(id int64, activityResource ActivityResource) (*APIResponse, error) {

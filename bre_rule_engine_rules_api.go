 ...
 * @return *PageBreRule
 */
func (a BRERuleEngineRulesApi) GetRulesUsingGET(filterName string, filterEnabled bool, filterSystem bool, filterTrigger string, filterAction string, filterCondition string, size int32, page int32) (*PageBreRule, *APIResponse, error) {
	...
	var successPayload = new(PageBreRule)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

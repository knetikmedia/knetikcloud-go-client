...
func (a *CampaignsRewardsApiService) CreateRewardSet(ctx context.Context, localVarOptionals map[string]interface{}) (RewardSetResource,  *http.Response, error) {
	var (
		...
		localVarFileBytes []byte
	 	successPayload  RewardSetResource
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rewards"
...
func (a *CampaignsRewardsApiService) DeleteRewardSet(ctx context.Context, id int32) ( *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rewards/{id}"
...
func (a *CampaignsRewardsApiService) GetRewardSets(localVarOptionals map[string]interface{}) (PageResourceRewardSetResource,  *http.Response, error) {
	var (
		...
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  PageResourceRewardSetResource
	)

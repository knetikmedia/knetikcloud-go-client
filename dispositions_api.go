...
func (a *DispositionsApiService) GetDispositionCounts(localVarOptionals map[string]interface{}) ([]DispositionCount,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *DispositionsApiService) GetDispositions(localVarOptionals map[string]interface{}) (PageResourceDispositionResource,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string

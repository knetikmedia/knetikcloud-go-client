...
# **CreateBRERule**
> BreRule CreateBRERule(optional)
Create a rule
...
> string GetBREExpressionAsString(optional)
...
# **GetBRERules**
> PageResourceBreRule GetBRERules(optional)
List rules
...
# **UpdateBRERule**
> BreRule UpdateBRERule(id, optional)
Update a rule

...
# **CreateBRERule**
> BreRule CreateBRERule(ctx, optional)
Create a rule
...
> string GetBREExpressionAsString(ctx, optional)
...
# **GetBRERules**
> PageResourceBreRule GetBRERules(ctx, optional)
List rules
...
# **UpdateBRERule**
> BreRule UpdateBRERule(ctx, id, optional)
Update a rule

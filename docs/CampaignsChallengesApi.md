...
[**PageBareChallengeActivityResource**](Page«BareChallengeActivityResource».md)
...
> PageChallengeEventResource GetChallengeEventssUsingGET($filterStartDateMin, $filterStartDateMax, $filterEndDateMin, $filterEndDateMax, $filterCampaigns, $filterChallenge, $size, $page, $order)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **filterStartDateMin** | **int64**| events starting after this date, unix timestamp in seconds | [optional] 
 **filterStartDateMax** | **int64**| events starting before this date, unix timestamp in seconds | [optional] 
 **filterEndDateMin** | **int64**| events ending after this date, unix timestamp in seconds | [optional] 
 **filterEndDateMax** | **int64**| events ending before this date, unix timestamp in seconds | [optional] 
...
[**PageChallengeEventResource**](Page«ChallengeEventResource».md)
...
[**PageChallengeResource**](Page«ChallengeResource».md)

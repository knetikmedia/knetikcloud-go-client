...
> PageAchievementDefinitionResource GetAchievementsUsingGET($filterTagset, $filterName, $filterHidden, $size, $page, $order)
...
[**PageAchievementDefinitionResource**](Page«AchievementDefinitionResource».md)
...
> PageUserAchievementResource GetAllUserProgressForAchievementUsingGET($achievementName, $filterAchievementTagset, $filterAchievementHidden, $size, $page)
...
[**PageUserAchievementResource**](Page«UserAchievementResource».md)
...
> PageUserAchievementResource GetAllUserProgressUsingGET($filterAchievementTagset, $filterAchievementName, $filterAchievementHidden, $size, $page)
...
> PageUserAchievementResource GetUserProgressUsingGET($userId, $filterAchievementTagset, $filterAchievementName, $filterAchievementHidden, $size, $page)
...
> UserAchievementResource UpdateProgressUsingPUT($userId, $achievementName, $request)

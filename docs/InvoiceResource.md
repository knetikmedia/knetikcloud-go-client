...
**Discount** | **float32** | The amount of money saved through coupons | [optional] [default to null]
...
**FedTax** | **float32** | The amount of federal tax added | [optional] [default to null]
**GrandTotal** | **float32** | The final price of the invoice | [optional] [default to null]
...
**RemainingBalance** | **float32** | The remaining price of the invoice (after any payments made so far) | [optional] [default to null]
**Shipping** | **float32** | The shipping cost | [optional] [default to null]

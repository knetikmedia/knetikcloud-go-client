...
[**PageCommentResource**](Page«CommentResource».md)
...
[**PageVideoRelationshipResource**](Page«VideoRelationshipResource».md)
...
[**PageVideoResource**](Page«VideoResource».md)
...
> UpdateRelationshipUsingPUT($videoId, $relationshipId, $details)

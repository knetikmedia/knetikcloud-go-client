...
**Countries** | **[]string** | A unique list of country iso3 codes that allow the shipping option | [optional] [default to null]
...
**MaxTierTotal** | **int32** | An abstract max value that the values of item&#39;s shipping_tier work against to decide whether an order can be fulfilled | [default to null]

...
> ItemTemplateResource CreateItemTemplateUsingPOST($itemTemplateResource)
...
> PageItemTemplateResource GetItemTemplatesUsingGET($size, $page, $order)
...
[**PageItemTemplateResource**](Page«ItemTemplateResource».md)
...
[**PageStoreItem**](Page«StoreItem».md)

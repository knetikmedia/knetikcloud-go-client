...
# **CreateBundleItem**
> BundleItem CreateBundleItem(ctx, optional)
...
> ItemTemplateResource CreateBundleTemplate(ctx, optional)
...
> DeleteBundleTemplate(ctx, id, optional)
...
# **UpdateBundleItem**
> BundleItem UpdateBundleItem(ctx, id, optional)
...
> ItemTemplateResource UpdateBundleTemplate(ctx, id, optional)

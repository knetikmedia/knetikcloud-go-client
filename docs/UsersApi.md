 ...
 **filterLastActivity** | **string**| A comma separated string without spaces.  First value is the operator to search on, second value is the date, a unix timestamp in seconds.  Allowed operators: (GT, LT, EQ, GOE, LOE). | 
 **filterIdList** | **string**| A comma separated list of ids. | 

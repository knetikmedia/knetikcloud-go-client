 ...
 */
func (a GamificationLevelingApi) GetLevelsUsingGET(filterName string, size int32, page int32, order string) (*PageResourceLevelingResource, *APIResponse, error) {
 ...
 */
func (a GamificationLevelingApi) GetUserLevelsUsingGET(userId int32) (*PageResourceUserLevelingResource, *APIResponse, error) {

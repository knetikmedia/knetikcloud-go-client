 ...
 */
func (a ReportingRevenueApi) ExecutiveRevenueCountrySalesUsingGET(currencyCode string, startDate int64, endDate int64, size int32, page int32) (*PageRevenueCountryReportResource, *APIResponse, error) {
	...
	var successPayload = new(PageRevenueCountryReportResource)
 ...
 */
func (a ReportingRevenueApi) ExecutiveRevenueProductSalesUsingGET(currencyCode string, startDate int64, endDate int64, size int32, page int32) (*PageRevenueProductReportResource, *APIResponse, error) {
	...
	var successPayload = new(PageRevenueProductReportResource)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

 ...
 */
func (a ReportingUsageApi) GetUsageByDayUsingGET(startDate int64, endDate int64, combineEndpoints bool, size int32, page int32) (*PageUsageInfo, *APIResponse, error) {
	...
	var successPayload = new(PageUsageInfo)
 ...
 * @return *PageUsageInfo
 */
func (a ReportingUsageApi) GetUsageByHourUsingGET(startDate int64, endDate int64, combineEndpoints bool, size int32, page int32) (*PageUsageInfo, *APIResponse, error) {
 ...
 * @return *PageUsageInfo
 */
func (a ReportingUsageApi) GetUsageByMinuteUsingGET(startDate int64, endDate int64, combineEndpoints bool, size int32, page int32) (*PageUsageInfo, *APIResponse, error) {
 ...
 * @return *PageUsageInfo
 */
func (a ReportingUsageApi) GetUsageByMonthUsingGET(startDate int64, endDate int64, combineEndpoints bool, size int32, page int32) (*PageUsageInfo, *APIResponse, error) {
 ...
 * @return *PageUsageInfo
 */
func (a ReportingUsageApi) GetUsageByYearUsingGET(startDate int64, endDate int64, combineEndpoints bool, size int32, page int32) (*PageUsageInfo, *APIResponse, error) {

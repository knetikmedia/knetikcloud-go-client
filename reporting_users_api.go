 ...
 */
func (a ReportingUsersApi) ExecutiveRevenueItemSalesUsingGET1(granularity string, startDate int64, endDate int64) (*PageResourceAggregateCountResource, *APIResponse, error) {

...
type Rule_Engine_ActionsApiService service


/* Rule_Engine_ActionsApiService Get a list of available actions
...
func (a *Rule_Engine_ActionsApiService) GetBREActions(ctx context.Context, localVarOptionals map[string]interface{}) ([]ActionResource,  *http.Response, error) {
	var (

...
type Rule_Engine_EventsApiService service


/* Rule_Engine_EventsApiService Fire a new event, based on an existing trigger
 ...
 * @param ctx context.Context Authentication Context 
 ...
 @return string*/
func (a *Rule_Engine_EventsApiService) SendBREEvent(ctx context.Context, localVarOptionals map[string]interface{}) (string,  *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/bre/events"

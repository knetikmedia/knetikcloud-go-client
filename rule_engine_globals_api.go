...
type Rule_Engine_GlobalsApiService service


/* Rule_Engine_GlobalsApiService Create a global definition
...
func (a *Rule_Engine_GlobalsApiService) CreateBREGlobal(ctx context.Context, localVarOptionals map[string]interface{}) (BreGlobalResource,  *http.Response, error) {
	var (
...
/* Rule_Engine_GlobalsApiService Delete a global
 ...
 * @param ctx context.Context Authentication Context 
 ...
 @return */
func (a *Rule_Engine_GlobalsApiService) DeleteBREGlobal(ctx context.Context, id string) ( *http.Response, error) {
	var (
...
/* Rule_Engine_GlobalsApiService Get a single global definition
 &lt;b&gt;Permissions Needed:&lt;/b&gt; BRE_RULE_ENGINE_GLOBALS_USER
 * @param ctx context.Context Authentication Context 
 @param id The id of the global definition
 @return BreGlobalResource*/
func (a *Rule_Engine_GlobalsApiService) GetBREGlobal(ctx context.Context, id string) (BreGlobalResource,  *http.Response, error) {
	var (
...
/* Rule_Engine_GlobalsApiService List global definitions
 &lt;b&gt;Permissions Needed:&lt;/b&gt; BRE_RULE_ENGINE_GLOBALS_USER
 * @param ctx context.Context Authentication Context 
 @param optional (nil or map[string]interface{}) with one or more of:
...
func (a *Rule_Engine_GlobalsApiService) GetBREGlobals(ctx context.Context, localVarOptionals map[string]interface{}) (PageResourceBreGlobalResource,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* Rule_Engine_GlobalsApiService Update a global definition
 ...
 * @param ctx context.Context Authentication Context 
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "breGlobalResource" (BreGlobalResource) The BRE global resource object
 @return BreGlobalResource*/
func (a *Rule_Engine_GlobalsApiService) UpdateBREGlobal(ctx context.Context, id string, localVarOptionals map[string]interface{}) (BreGlobalResource,  *http.Response, error) {
	var (

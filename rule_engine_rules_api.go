...
type Rule_Engine_RulesApiService service


/* Rule_Engine_RulesApiService Create a rule
 ...
 * @param ctx context.Context Authentication Context 
 ...
 @return BreRule*/
func (a *Rule_Engine_RulesApiService) CreateBRERule(ctx context.Context, localVarOptionals map[string]interface{}) (BreRule,  *http.Response, error) {
	var (
...
/* Rule_Engine_RulesApiService Delete a rule
 ...
 * @param ctx context.Context Authentication Context 
 ...
 @return */
func (a *Rule_Engine_RulesApiService) DeleteBRERule(ctx context.Context, id string) ( *http.Response, error) {
	var (
...
/* Rule_Engine_RulesApiService Returns a string representation of the provided expression
 &lt;b&gt;Permissions Needed:&lt;/b&gt; BRE_RULE_ENGINE_RULES_ADMIN
 * @param ctx context.Context Authentication Context 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "expression" (Expressionobject) The expression
 @return string*/
func (a *Rule_Engine_RulesApiService) GetBREExpressionAsString(ctx context.Context, localVarOptionals map[string]interface{}) (string,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
...
/* Rule_Engine_RulesApiService Get a single rule
 &lt;b&gt;Permissions Needed:&lt;/b&gt; BRE_RULE_ENGINE_RULES_ADMIN
 * @param ctx context.Context Authentication Context 
 @param id The id of the rule
 @return BreRule*/
func (a *Rule_Engine_RulesApiService) GetBRERule(ctx context.Context, id string) (BreRule,  *http.Response, error) {
	var (
...
/* Rule_Engine_RulesApiService List rules
 &lt;b&gt;Permissions Needed:&lt;/b&gt; BRE_RULE_ENGINE_RULES_ADMIN
 * @param ctx context.Context Authentication Context 
 @param optional (nil or map[string]interface{}) with one or more of:
...
func (a *Rule_Engine_RulesApiService) GetBRERules(ctx context.Context, localVarOptionals map[string]interface{}) (PageResourceBreRule,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* Rule_Engine_RulesApiService Enable or disable a rule
 ...
 * @param ctx context.Context Authentication Context 
 ...
 @return */
func (a *Rule_Engine_RulesApiService) SetBRERule(ctx context.Context, id string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
...
/* Rule_Engine_RulesApiService Update a rule
 ...
 * @param ctx context.Context Authentication Context 
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "breRule" (BreRule) The BRE rule object
 @return BreRule*/
func (a *Rule_Engine_RulesApiService) UpdateBRERule(ctx context.Context, id string, localVarOptionals map[string]interface{}) (BreRule,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody interface{}
		localVarFileName string

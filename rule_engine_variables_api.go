...
type Rule_Engine_VariablesApiService service


/* Rule_Engine_VariablesApiService Get a list of variable types available
...
func (a *Rule_Engine_VariablesApiService) GetBREVariableTypes(ctx context.Context, ) ([]VariableTypeResource,  *http.Response, error) {
	var (
...
/* Rule_Engine_VariablesApiService List valid values for a type
...
func (a *Rule_Engine_VariablesApiService) GetBREVariableValues(ctx context.Context, name string, localVarOptionals map[string]interface{}) (PageResourceSimpleReferenceResourceobject,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string

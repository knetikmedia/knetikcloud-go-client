 ...
 */
func (a StoreApi) CreateItemTemplateUsingPOST(itemTemplateResource ItemTemplateResource) (*ItemTemplateResource, *APIResponse, error) {
 ...
 * @return *ItemTemplateResource
 */
func (a StoreApi) GetItemTemplateUsingGET(id string) (*ItemTemplateResource, *APIResponse, error) {
 ...
 */
func (a StoreApi) GetItemTemplatesUsingGET(size int32, page int32, order string) (*PageItemTemplateResource, *APIResponse, error) {
 ...
 */
func (a StoreApi) GetStoreItemsUsingGET(filterNameSearch string, filterUniqueKey string, filterPublished bool, filterDisplayable bool, filterStart string, filterEnd string, filterStartDate string, filterStopDate string, filterSku string, filterPrice string, filterTag string, filterItemsByType string, filterBundledSkus string, size int32, page int32, order string) (*PageStoreItem, *APIResponse, error) {
	...
	var successPayload = new(PageStoreItem)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
 ...
 * @return *PageStoreItem
 */
func (a StoreApi) GetUsingGET2(storeListRequest StoreListRequest) (*PageStoreItem, *APIResponse, error) {
	...
	// body params
	localVarPostBody = &storeListRequest
	var successPayload = new(PageStoreItem)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
 ...
 * @return void
 */
func (a StoreApi) UpdateItemTemplateUsingPUT(id string, itemTemplateResource ItemTemplateResource) (*APIResponse, error) {

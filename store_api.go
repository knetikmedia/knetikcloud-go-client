 ...
 * @return *StoreItem
 */
func (a StoreApi) CreateStoreItem(cascade bool, storeItem StoreItem) (*StoreItem, *APIResponse, error) {
 ...
 */
func (a StoreApi) GetBehaviors() ([]BehaviorDefinitionResource, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/store/items/behaviors"
	...
	var successPayload = new([]BehaviorDefinitionResource)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GetBehaviors", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 * @return *PageResourceStoreItem
 */
func (a StoreApi) GetStoreItems(filterNameSearch string, filterUniqueKey string, filterPublished bool, filterDisplayable bool, filterStart string, filterEnd string, filterStartDate string, filterStopDate string, filterSku string, filterPrice string, filterTag string, filterItemsByType string, filterBundledSkus string, filterVendor int32, size int32, page int32, order string) (*PageResourceStoreItem, *APIResponse, error) {
 ...
 * @return *StoreItemTemplateResource
 */
func (a StoreApi) UpdateItemTemplate(id string, itemTemplateResource StoreItemTemplateResource) (*StoreItemTemplateResource, *APIResponse, error) {
 ...
 * @return *StoreItem
 */
func (a StoreApi) UpdateStoreItem(id int32, cascade bool, storeItem StoreItem) (*StoreItem, *APIResponse, error) {

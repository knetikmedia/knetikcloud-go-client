...
type SubscriptionPlanResource struct {
	...
	InitialFee float32 `json:"initial_fee"`
	...
	LatePaymentFee float32 `json:"late_payment_fee"`
	...
	ReactivationFee float32 `json:"reactivation_fee"`
	...
	RecurringFee float32 `json:"recurring_fee"`

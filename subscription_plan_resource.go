...
type SubscriptionPlanResource struct {
	...
	BillingCycleLength int32 `json:"billing_cycle_length,omitempty"`

	// The time period unit to apply to the length of billing cycles
	BillingCycleUnit string `json:"billing_cycle_unit,omitempty"`
	...
	InitialFee float64 `json:"initial_fee,omitempty"`
	...
	LatePaymentFee float64 `json:"late_payment_fee,omitempty"`
	...
	ReactivationFee float64 `json:"reactivation_fee,omitempty"`
	...
	RecurringFee float64 `json:"recurring_fee,omitempty"`
